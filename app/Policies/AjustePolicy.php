...
class AjustePolicy
{
    ...
    public function update(User $user, Ajuste $record): bool { return $user->can('ajustes.crear'); }
    public function delete(User $user, Ajuste $record): bool { return $user->can('ajustes.crear'); }
}
