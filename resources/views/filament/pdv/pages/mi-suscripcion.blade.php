<x-filament-panels::page>
    <style>
        ...
        .msp-hero > div { min-width: 0; flex: 1; }
        .msp-hero-svg   { width: 2rem; height: 2rem; color: #fff; }
        .msp-hero-title { font-size: 1.1rem; font-weight: 700; margin: 0 0 .2rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .msp-hero-sub   { font-size: .825rem; opacity: .85; margin: 0; line-height: 1.45; word-break: break-word; }
        ...
        @media (max-width: 640px) {
            ...
            .msp-wrapper { gap: 1rem; }
            .msp-hero { padding: 1rem; gap: .75rem; }
            .msp-hero-icon { display: none; }
            .msp-hero-title { font-size: 1rem; }
            .msp-card { padding: 1rem; }
            .msp-plan-name { font-size: 1.1rem; }
            .msp-price-amount { font-size: 1.8rem; }
            .msp-countdown { flex-wrap: wrap; gap: .35rem; font-size: .8rem; }
        }
        ...
        .msp-badge-aprobado  { background: var(--msp-ok-bg);   color: var(--msp-ok-fg); }
        .msp-badge-rechazado { background: var(--msp-err-bg);  color: var(--msp-err-fg); }
        .msp-badge-pendiente { background: var(--msp-warn-bg); color: var(--msp-warn-fg); }
        ...
        /* ── History (tabla Filament — scroll nativo) ───────────────────── */
