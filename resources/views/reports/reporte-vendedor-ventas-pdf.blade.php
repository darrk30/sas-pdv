...
.badge-credito { background: #fef3c7; color: #92400e; padding: 1px 5px; font-size: 7px; font-weight: 700; }
.badge-contado { background: #dcfce7; color: #166534; padding: 1px 5px; font-size: 7px; font-weight: 700; }
...
<table style="margin-bottom:6px;">
    <tr>
        ...
        <td style="background:#1E3A5F;padding:8px 12px;text-align:right;vertical-align:middle;">
            <div style="font-size:13px;font-weight:bold;text-transform:uppercase;color:#fff;">Ventas del vendedor</div>
            <div style="font-size:9px;color:#c7d7ee;margin-top:2px;">{{ $vendedorNombre }}</div>
    ...
    <tr>
        ...
        <td style="vertical-align:top;padding-left:6px;width:50%;">
            <div style="background:#f0fdf4;padding:5px 8px;">
                ...
                @php $totalVentas = $rows->sum(fn($r) => (float)($r['total'] ?? 0)); $margen = $totalVentas > 0 ? round($resumen['utilidad'] / $totalVentas * 100, 1) : 0; @endphp
                <table style="margin:0;">
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Utilidad neta</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">S/ {{ number_format($resumen['utilidad'], 2) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Margen</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">{{ number_format($margen, 1) }}%</td></tr>
                </table>
            </div>
        </td>
    </tr>
