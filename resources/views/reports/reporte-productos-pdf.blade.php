...
<table style="margin-bottom:6px;">
    <tr>
        ...
        <td style="background:#1E3A5F;padding:8px 12px;text-align:right;vertical-align:middle;">
            <div style="font-size:13px;font-weight:bold;text-transform:uppercase;color:#fff;">Productos más vendidos</div>
    ...
    <tr>
        <td style="vertical-align:top;padding-right:6px;width:50%;">
            <div style="background:#EBF0F8;padding:5px 8px;">
                <div style="font-size:8px;font-weight:bold;color:#1E3A5F;text-transform:uppercase;margin-bottom:4px;">Productos</div>
                <table style="margin:0;">
                    <tr><td style="font-size:7.5px;color:#2C5282;font-weight:bold;padding:1px 0;">Total productos</td><td style="font-size:7.5px;text-align:right;font-weight:bold;padding:1px 0;">{{ number_format($resumen['productos']) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#2C5282;font-weight:bold;padding:1px 0;">Unidades vendidas</td><td style="font-size:7.5px;text-align:right;font-weight:bold;padding:1px 0;">{{ number_format($resumen['unidades'], 2) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#2C5282;font-weight:bold;padding:1px 0;">Ingresos totales</td><td style="font-size:7.5px;text-align:right;font-weight:bold;padding:1px 0;">S/ {{ number_format($resumen['ingresos'], 2) }}</td></tr>
                </table>
            </div>
        </td>
        <td style="vertical-align:top;padding-left:6px;width:50%;">
            <div style="background:#f0fdf4;padding:5px 8px;">
                ...
                <table style="margin:0;">
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Costo de ventas</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">S/ {{ number_format($resumen['costo'], 2) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Utilidad total</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">S/ {{ number_format($resumen['utilidad'], 2) }}</td></tr>
