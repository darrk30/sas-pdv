...
<table style="margin-bottom:6px;">
    <tr>
        ...
        <td style="background:#1E3A5F;padding:8px 12px;text-align:right;vertical-align:middle;">
            <div style="font-size:13px;font-weight:bold;text-transform:uppercase;color:#fff;">Reporte de Ganancias</div>
...
<table>
    ...
    <tbody>
        ...
        <tr style="background:{{ $bg }}">
            ...
            @php
                $val     = $row[$key] ?? '';
                $isMoney = in_array($key, $moneyKeys) && is_numeric($val) && (float)$val !== 0.0;
    ...
    <tr>
        <td style="vertical-align:top;padding-right:6px;width:50%;">
            <div style="background:#EBF0F8;padding:5px 8px;">
                <div style="font-size:8px;font-weight:bold;color:#1E3A5F;text-transform:uppercase;margin-bottom:4px;">Totales</div>
                <table style="margin:0;">
                    <tr><td style="font-size:7.5px;color:#2C5282;font-weight:bold;padding:1px 0;">Ingresos brutos</td><td style="font-size:7.5px;text-align:right;font-weight:bold;padding:1px 0;">S/ {{ number_format($resumen['ingresosBrutos'], 2) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#2C5282;font-weight:bold;padding:1px 0;">Ventas netas</td><td style="font-size:7.5px;text-align:right;font-weight:bold;padding:1px 0;">S/ {{ number_format($resumen['ventasNetas'], 2) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#2C5282;font-weight:bold;padding:1px 0;">Costo de ventas</td><td style="font-size:7.5px;text-align:right;font-weight:bold;padding:1px 0;">S/ {{ number_format($resumen['costoTotal'], 2) }}</td></tr>
                </table>
            </div>
        </td>
        <td style="vertical-align:top;padding-left:6px;width:50%;">
            <div style="background:#f0fdf4;padding:5px 8px;">
                ...
                <table style="margin:0;">
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Ventas ({{ $resumen['cantidad'] }})</td><td style="font-size:7.5px;text-align:right;padding:1px 0;"></td></tr>
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Utilidad cobrada</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">S/ {{ number_format($resumen['utilidadRealizada'], 2) }}</td></tr>
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Margen bruto</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">{{ number_format($resumen['margenPct'], 1) }}%</td></tr>
                    ...
                    <tr><td style="font-size:7.5px;color:#166534;padding:1px 0;">Utilidad en riesgo</td><td style="font-size:7.5px;text-align:right;padding:1px 0;">S/ {{ number_format($resumen['utilidadEnRiesgo'], 2) }}</td></tr>
                    @endif
                </table>
            </div>
        </td>
