...
<div class="header">
    ...
    <div class="header-right">
        <div class="header-reporte">Reporte de Ganancias</div>
...
<div class="metodos-wrap">
    ...
    <div class="metodos-box">
        <div class="metodos-titulo">Totales</div>
        <div class="metodo-row">
            <span class="metodo-nombre">Ingresos brutos</span>
            <span class="metodo-monto">S/ {{ number_format($resumen['ingresosBrutos'], 2) }}</span>
        </div>
        <div class="metodo-row">
            <span class="metodo-nombre">Ventas netas</span>
            <span class="metodo-monto">S/ {{ number_format($resumen['ventasNetas'], 2) }}</span>
        </div>
        <div class="metodo-row">
            <span class="metodo-nombre">Costo de ventas</span>
            <span class="metodo-monto">S/ {{ number_format($resumen['costoTotal'], 2) }}</span>
        </div>
    </div>
    ...
    <div class="resumen-box">
        ...
        <div class="resumen-row">
            <span class="resumen-label">Ventas ({{ $resumen['cantidad'] }})</span>
            <span></span>
        </div>
        <div class="resumen-row">
            <span class="resumen-label">Utilidad cobrada</span>
            <span>S/ {{ number_format($resumen['utilidadRealizada'], 2) }}</span>
        </div>
        <div class="resumen-row">
        ...
        <div class="resumen-row">
            <span class="resumen-label">Utilidad en riesgo</span>
            <span>S/ {{ number_format($resumen['utilidadEnRiesgo'], 2) }}</span>
        </div>
        @endif
    </div>
